...
export const EBOOK_SAMPLES: EbookSampleItem[] = [
  {
    ...
    title: "Gâteaux Moelleux & Goûters d'Antan",
    subtitle: "Les secrets des cakes fondants, marbrés et financiers",
    tag: "CLASSIQUES",
    category: "Gâteaux & Cakes",
    coverImage: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=800&q=80",
    recipesCount: "12 Fiches Recettes",
    pages: "34 Pages HD",
    highlightRecipes: ["Marbré vanille-chocolat grand cru", "Moelleux au citron de Menton", "Financiers noisettes du Piémont"]
  },
  {
    id: "eb-2",
    volumeNumber: "VOLUME 02",
    title: "L'Univers Intense du Chocolat",
    subtitle: "Coulants, fondants, ganaches et truffes fondantes",
    tag: "CACAO GRAND CRU",
    category: "Chocolat & Ganaches",
    coverImage: "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=800&q=80",
    recipesCount: "14 Fiches Recettes",
    pages: "38 Pages HD",
    highlightRecipes: ["Fondant cœur coulant noir 70%", "Tarte chocolat caramel beurre salé", "Mousse aérienne au chocolat noir"]
  },
  {
    id: "eb-3",
    volumeNumber: "VOLUME 03",
    title: "Tartes d'Exception & Pâtes Croustillantes",
    subtitle: "Pâtes sablées, brisées, feuilletées et fonçages parfaits",
    tag: "TARTES & FRUITS",
    category: "Tartes & Tartelettes",
    coverImage: "https://images.unsplash.com/photo-1519915028121-7d3463d20b13?auto=format&fit=crop&w=800&q=80",
    recipesCount: "12 Fiches Recettes",
    pages: "36 Pages HD",
    highlightRecipes: ["Tarte fine aux fraises Gariguette", "Tarte au citron meringuée dorée", "Tartelette tatin caramélisée"]
  },
  {
    id: "eb-4",
    volumeNumber: "VOLUME 04",
    title: "Cookies, Sablés & Biscuits Gourmands",
    subtitle: "Croustillants dehors, fondants et moelleux à cœur",
    tag: "BISCUITERIE",
    category: "Biscuits & Cookies",
    coverImage: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "28 Pages HD",
    highlightRecipes: ["Cookies géants chocolat-noisettes", "Sablés pur beurre à la fleur de sel", "Madeleines à la coque chocolatée"]
  },
  {
    id: "eb-5",
    volumeNumber: "VOLUME 05",
    title: "Desserts Frais & Fruits de Saison",
    subtitle: "Légèreté, équilibre et éclat naturel des fruits",
    tag: "FRUITS & FRAÎCHEUR",
    category: "Douceurs Fruitées",
    coverImage: "https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "30 Pages HD",
    highlightRecipes: ["Pavlova fruits rouges & crème vanille", "Carpaccio d'ananas au sirop d'épices", "Clafoutis fondant aux cerises noires"]
  },
  {
    id: "eb-6",
    volumeNumber: "VOLUME 06",
    title: "Crèmes, Mousses & Verrines de Soirée",
    subtitle: "La douceur à l'état pur pour clore vos repas",
    tag: "ONCTUOSITÉ",
    category: "Crèmes & Verrines",
    coverImage: "https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "32 Pages HD",
    highlightRecipes: ["Crème brûlée vanille Bourbon craquante", "Panna cotta coulis de mangue passion", "Tiramisu traditionnel crémeux"]
  },
  {
    id: "eb-7",
    volumeNumber: "VOLUME 07",
    title: "Viennoiseries Dorées & Brioches Moelleuses",
    subtitle: "Le savoir-faire de la boulangerie française chez soi",
    tag: "BOULANGERIE",
    category: "Viennoiseries",
    coverImage: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "32 Pages HD",
    highlightRecipes: ["Brioche tressée ultra filante", "Pains au chocolat pur beurre", "Cinnamon rolls glacés au cream cheese"]
  },
  {
    id: "eb-8",
    volumeNumber: "VOLUME 08",
    title: "Desserts Express & Sans Cuisson",
    subtitle: "Réalisables en moins de 15 minutes chrono",
    tag: "EXPRESS < 15 MIN",
    category: "Sans Four",
    coverImage: "https://images.unsplash.com/photo-1533134242443-d4fd215305ad?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "26 Pages HD",
    highlightRecipes: ["Cheesecake sans cuisson coulis framboise", "Mousse 2 ingrédients express", "Bouchées glacées choco-banane"]
  },
  {
    id: "eb-9",
    volumeNumber: "VOLUME 09",
    title: "Haute Pâtisserie & Fêtes Gourmandes",
    subtitle: "Entremets, macarons, glaçages et pièces d'exception",
    tag: "HAUTE PÂTISSERIE",
    category: "Occasions & Fêtes",
    coverImage: "https://images.unsplash.com/photo-1535141192574-5d4897c13136?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "36 Pages HD",
    highlightRecipes: ["Paris-Brest praliné amandes-noisettes", "Bûche royale chocolat passion", "Macarons ganache montée vanille"]
  },
  {
    id: "eb-10",
    volumeNumber: "VOLUME 10",
    title: "Crêpes, Pancakes & Douceurs Brunch",
    subtitle: "Pâtes sans grumeaux et garnitures maison irrésistibles",
    tag: "BRUNCH & MATIN",
    category: "Crêpes & Gaufres",
    coverImage: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?auto=format&fit=crop&w=800&q=80",
    recipesCount: "10 Fiches Recettes",
    pages: "28 Pages HD",
    highlightRecipes: ["Pancakes soufflés ultra moelleux", "Crêpes légères à la fleur d'oranger", "Gaufres liégeoises au sucre perlé"]
  }
];
...
export const BONUSES: BonusItem[] = [
  ...
  },
  {
    ...
    subtitle: "Plus de 70 recettes autour des fruits",
